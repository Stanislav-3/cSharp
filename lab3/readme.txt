...
2. ETL(Windows-служба)
Проект windows-службы, использующий Converter.dll. 
...
MovingOptions - настройки путей к папкам(sourceDir, targetDir, enabling logging and enabling additional archive)
