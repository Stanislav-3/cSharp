...
namespace lab8
{
    public class Human : IComparable<Human>
    {
        ...
        public delegate void PersonalInfoChangedHandler(string message);
        public static event PersonalInfoChangedHandler DivorceMessage;
        public static event PersonalInfoChangedHandler MarriageMessage;
        public static event PersonalInfoChangedHandler FamilyMessage;
        ...
        public static bool Marry(Human human1, Human human2)
        {
            ...
            MarriageMessage?.Invoke($"{human1.FullName} & {human2.FullName} are marrieds now");
            return true;
        }
        ...
        public bool Divorce()
        {
            ...
            Partner = null;
            DivorceMessage?.Invoke($"{this.FullName} is lonely now");
            return true;
        }
        ...
        public bool SetParent(Human parent)
        {
            ...
            if (parent.IsMale)
            {
                ...
                Father = parent;
                FamilyMessage?.Invoke($"{parent.FullName} became a father for {this.FullName}");
            }
            else
            {
                if (Mother != null) return false;
                Mother = parent;
                FamilyMessage?.Invoke($"{parent.FullName} became a mother for {this.FullName}");
            }
